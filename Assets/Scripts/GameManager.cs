...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SaveEnemySpawn(DateTimeOffset.Now.ToUnixTimeSeconds(), "rouge");
        SaveEnemySpawn(DateTimeOffset.Now.ToUnixTimeSeconds(), "violet");
        SaveEnemySpawn(DateTimeOffset.Now.ToUnixTimeSeconds(), "vert");
        ...
        SavePlayerHealth(DateTimeOffset.Now.ToUnixTimeSeconds(), 10, 10);
        SavePlayerHealth(DateTimeOffset.Now.ToUnixTimeSeconds(), 8, 10);
        SavePlayerHealth(DateTimeOffset.Now.ToUnixTimeSeconds(), 8, 15);
        ...
        SaveEndGame(startTimestamp, DateTimeOffset.Now.ToUnixTimeSeconds());

        StartCoroutine(SendMetricsToWebService());
    }
